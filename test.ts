...
declare function get<P extends Path<SomeState>>(
  path: P
): PathValue<SomeState, P>;

declare function sub<P extends Path<SomeState>>(
  path: P,
  callback: (val: PathValue<SomeState, P>) => void
): void;
